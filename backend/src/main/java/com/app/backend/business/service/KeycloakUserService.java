...
public class KeycloakUserService {
    ...
    public ResponseEntity<?> updateUserInformations(FormUserDto formUserDto,
        ...
        try {
            ...
            String dynamicJsonForUserInfo = String.format("{\"firstName\":\"%s\",\"lastName\":\"%s\",\"email\":\"%s\"}",
                    formUserDto.getGiven_name(), formUserDto.getFamily_name(), formUserDto.getEmail());
            ...
            return ResponseEntity.status(500).body("There is an error when updating...");
        }
